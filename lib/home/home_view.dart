...
import 'package:landingpage_gojek/home/home_model.dart';
import 'package:landingpage_gojek/home/home_appbar.dart';
import 'dart:async';
...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    _gojekServiceList.add(new GojekService(
        ...
        color: ColorPallete.menuCar,
        title: "GO-CAR"));
    _gojekServiceList.add(new GojekService(
        image: Icons.directions_car,
        color: ColorPallete.menuBluebird,
        title: "GO-BLUEBIRD"));
    _gojekServiceList.add(new GojekService(
        image: Icons.restaurant,
        color: ColorPallete.menuFood,
        title: "GO-FOOD"));
    _gojekServiceList.add(new GojekService(
    ...
    _gojekServiceList.add(new GojekService(
        ...
        color: ColorPallete.menuDeals,
        title: "GO-DEALS"));
    _gojekServiceList.add(new GojekService(
        image: Icons.phonelink_ring,
        color: ColorPallete.menuPulsa,
        title: "GO-PULSA"));
    _gojekServiceList.add(new GojekService(
        image: Icons.apps, color: ColorPallete.menuOther, title: "LAINNYA"));
    _gojekServiceList.add(new GojekService(
        image: Icons.shopping_basket,
        color: ColorPallete.menuShop,
        title: "GO-SHOP"));
    _gojekServiceList.add(new GojekService(
        ...
        title: "GO-MART"));
    _gojekServiceList.add(new GojekService(
        image: Icons.local_play, color: ColorPallete.menuTix, title: "GO-TIX"));
  }
      ...
      child: new Column(
        ...
        children: <Widget>[
          new GestureDetector(
            ...
            child: new Container(
              decoration: new BoxDecoration(
                  border: Border.all(color: ColorPallete.grey200, width: 1.0),
                  borderRadius:
            ...
            children: <Widget>[
              ...
              new OutlineButton(
                ...
                child: new Text(
                  "EDIT FAVORITES",
                  style:
                      new TextStyle(fontSize: 12.0, color: ColorPallete.green),
                ),
              ),
            ],
          ),
